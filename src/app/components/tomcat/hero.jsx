const Hero = () => {
  return (
    <section className="w-[100vw] py-[6rem] flex items-center justify-center bg-[#0D1117] bg-blend-soft-light sm:py-[40rem] sm:bg-[length:100%_auto] bg-[length:100%_100%]  bg-no-repeat bg-tomcat-hero-bg">
